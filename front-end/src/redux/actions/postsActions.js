...
import {
 ...
 export const editComment = (action, commenterId, postId, text) => dispatch =>
 ...
 export const editPost = (id, text, author) => dispatch => 
                            axios.patch(`/posts/${id}`, { id, text, author}).then(res => dispatch({
                                type: EDIT_POST,
                                id,
                                text,
                                author
 ...
 export const updatePostLikes = (action, postId, likerId) => dispatch =>
                                axios.patch(`/posts/${postId}`, { action, id: likerId}).then(res => dispatch({
